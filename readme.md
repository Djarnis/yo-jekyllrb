...
Running "concurrent:server" (concurrent) task
    ...
    Execution Time (2015-12-08 20:15:24 UTC)
    loading tasks  3.5s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 99%
    Total 3.5s
    ...
    Execution Time (2015-12-08 20:15:24 UTC)
    loading tasks  3.5s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 98%
    sass:server    59ms  ▇ 2%
    Total 3.5s
        Warning: Running "jekyll:server" (jekyll) task
    >> Error: Command failed: /bin/sh -c jekyll -v
    >> /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/resolver.rb:296:in `resolve': Could not find gem 'jekyll (~> 2.3.0) ruby' in the gems available on this machine. (Bundler::GemNotFound)
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/resolver.rb:168:in `start'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/resolver.rb:129:in `block in resolve'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/resolver.rb:128:in `catch'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/resolver.rb:128:in `resolve'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/definition.rb:179:in `resolve'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/definition.rb:114:in `specs'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/definition.rb:159:in `specs_for'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/definition.rb:148:in `requested_specs'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/environment.rb:18:in `requested_specs'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler/runtime.rb:13:in `setup'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320@global/gems/bundler-1.3.5/lib/bundler.rb:120:in `setup'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320/gems/jekyll-2.5.3/lib/jekyll/plugin_manager.rb:37:in `require_from_bundler'
    >>  from /usr/local/rvm/gems/ruby-1.9.2-p320/gems/jekyll-2.5.3/bin/jekyll:16:in `<top (required)>'
    >>  from /Users/jeppe/.rbenv/versions/2.1.5/bin/jekyll:23:in `load'
    >>  from /Users/jeppe/.rbenv/versions/2.1.5/bin/jekyll:23:in `<main>'
...
Execution Time (2015-12-08 20:15:21 UTC)
loading tasks      2.1s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 25%
concurrent:server  6.5s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 75%
Total 8.6s

$ git init
Initialized empty Git repository in /Users/jeppe/apps/mdd/mdd_yo_jekyll/.git/
$ git add .
$ git commit -m "Initial yo jekyllrb install"
[master (root-commit) ce06278] Initial yo jekyllrb install
 44 files changed, 3346 insertions(+)
 ...
 create mode 100644 _config.build.yml
 create mode 100644 _config.yml
 create mode 100644 app/.htaccess
 create mode 100644 app/404.html
 create mode 100644 app/_h5bp-docs/CHANGELOG.md
 create mode 100644 app/_h5bp-docs/CONTRIBUTING.md
 create mode 100644 app/_h5bp-docs/LICENSE.md
 create mode 100644 app/_h5bp-docs/README.md
 create mode 100644 app/_h5bp-docs/code-docs/TOC.md
 create mode 100644 app/_h5bp-docs/code-docs/crossdomain.md
 create mode 100644 app/_h5bp-docs/code-docs/css.md
 create mode 100644 app/_h5bp-docs/code-docs/extend.md
 create mode 100644 app/_h5bp-docs/code-docs/faq.md
 create mode 100644 app/_h5bp-docs/code-docs/html.md
 create mode 100644 app/_h5bp-docs/code-docs/js.md
 create mode 100644 app/_h5bp-docs/code-docs/misc.md
 create mode 100644 app/_h5bp-docs/code-docs/usage.md
 create mode 100644 app/_includes/googleanalytics.html
 create mode 100644 app/_includes/scripts.html
 create mode 100755 app/_layouts/default.html
 create mode 100755 app/_layouts/post.html
 create mode 100644 app/_posts/2015-12-08-welcome-to-jekyll.md
 create mode 100644 app/_posts/2015-12-08-yo-jekyllrb.md
 create mode 100644 app/_scss/readme.md
 create mode 100755 app/_src/readme.md
 create mode 100644 app/apple-touch-icon-precomposed.png
 create mode 100644 app/crossdomain.xml
 create mode 100644 app/css/main.css
 create mode 100644 app/favicon.ico
 create mode 100644 app/humans.txt
 create mode 100644 app/index.html
 create mode 100644 app/js/main.js
 create mode 100644 app/js/plugins.js
 create mode 100644 app/robots.txt
 create mode 100644 bower.json
 create mode 100644 package.json
$ git remote add origin https://github.com/Djarnis/yo-jekyllrb.git
$ git push -u origin master
Counting objects: 56, done.
Delta compression using up to 4 threads.
Compressing objects: 100% (49/49), done.
Writing objects: 100% (56/56), 46.46 KiB | 0 bytes/s, done.
...
Running "concurrent:server" (concurrent) task
    ...
    Execution Time (2015-12-08 20:21:23 UTC)
    loading tasks  3.5s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 99%
    copy:stageCss  40ms  ▇ 1%
    Total 3.6s
    ...
    loading tasks  3.5s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 64%
    jekyll:server    2s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 36%
    Total 5.5s Use --force to continue.
        
        Aborted due to warnings.
    

Execution Time (2015-12-08 20:21:19 UTC)
loading tasks      2.4s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 26%
concurrent:server  6.7s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 74%
Total 9.1s
...
Running "concurrent:dist" (concurrent) task
    ...
    Execution Time (2015-12-08 20:40:53 UTC)
    loading tasks  3.8s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 99%
    Total 3.8s
...
Execution Time (2015-12-08 20:40:43 UTC)
loading tasks       2.9s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 19%
jekyll:check        3.2s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 21%
jshint:all         193ms  ▇▇ 1%
jekyll:dist         2.8s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 18%
concurrent:dist     4.9s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 31%
autoprefixer:dist  236ms  ▇▇▇ 2%
...
Running "concurrent:dist" (concurrent) task
    ...
    Execution Time (2015-12-08 20:42:12 UTC)
    loading tasks  4.4s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 99%
    Total 4.4s
...
Creating git repository in dist.
Initialized empty Git repository in /Users/jeppe/apps/mdd/mdd_yo_jekyll/dist/.git/

Creating branch "gh-pages".
Switched to a new branch 'gh-pages'

Committing changes to gh-pages.
[gh-pages (root-commit) b0f4160] Built mdd-yo-jekyll from commit b0a8090 on branch master
 12 files changed, 741 insertions(+)
 create mode 100644 .htaccess
 create mode 100644 404.html
 create mode 100644 apple-touch-icon-precomposed.png
 create mode 100644 crossdomain.xml
 create mode 100644 css/main.d92f.css
 create mode 100644 favicon.ico
 create mode 100644 humans.txt
 create mode 100644 index.html
 create mode 100644 jekyll/update/2015/12/08/yo-jekyllrb.html
 create mode 100644 js/head-scripts.32fa.js
 create mode 100644 js/script.d16b.js
...
Execution Time (2015-12-08 20:42:02 UTC)
loading tasks       2.2s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 11%
jekyll:check        2.9s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 15%
jshint:all         208ms  ▇▇ 1%
jekyll:dist         3.1s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 16%
concurrent:dist     5.5s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 28%
...
Running "concurrent:dist" (concurrent) task
    ...
    Execution Time (2015-12-08 20:44:48 UTC)
    loading tasks  3.9s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 99%
    Total 3.9s
...
Execution Time (2015-12-08 20:44:37 UTC)
loading tasks         3s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 19%
jekyll:check        3.3s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 21%
jshint:all         207ms  ▇▇▇ 1%
jekyll:dist         2.9s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 18%
concurrent:dist     4.9s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 31%
autoprefixer:dist  213ms  ▇▇▇ 1%
uglify:generated   422ms  ▇▇▇▇▇ 3%
...
Running "concurrent:server" (concurrent) task
    ...
    Execution Time (2015-12-08 20:47:14 UTC)
    loading tasks  4.9s  ▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇ 99%
    coffee:dist    52ms  ▇ 1%
    Total 5s
